...
class Category extends Model {
  ...
  Category({this.id, this.name, this.description, this.color, this.image, bool? featured, List<Category>? subCategories, List<EService>? eServices}) 
    : featured = featured ?? false,
      subCategories = subCategories ?? const [],
      eServices = eServices ?? const [];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['color'] = this.color != null ? '#${this.color!.value.toRadixString(16)}' : null;
    return data;
  }
