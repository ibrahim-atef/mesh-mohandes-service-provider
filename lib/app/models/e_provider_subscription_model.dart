...
class EProviderSubscription extends Model {
  ...
  EProviderSubscription({this.id, this.eProvider, this.subscriptionPackage, this.startsAt, this.expiresAt, this.payment, bool? active}) : active = active ?? false;
  ...
  EProviderSubscription.fromJson(Map<String, dynamic> json) {
    ...
    startsAt = dateFromJson(json, 'starts_at');
    expiresAt = dateFromJson(json, 'expires_at');
