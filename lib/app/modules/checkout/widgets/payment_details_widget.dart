      ...
      child: Wrap(
        ...
        children: <Widget>[
          ...
          BookingRowWidget(
            ...
            valueStyle: Get.textTheme.bodyText2 ?? TextStyle(),
            child: Align(
              alignment: Alignment.centerRight,
              child: Ui.getPrice(_eProviderSubscription.subscriptionPackage?.getPrice ?? 0.0, style: Get.textTheme.subtitle2 ?? TextStyle()),
            ),
          ),
        ],
      ),
